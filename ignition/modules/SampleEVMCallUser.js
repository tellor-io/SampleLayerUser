...
module.exports = buildModule("SampleEVMCallUserModule", (m) => {
  ...
  const sampleEVMCallUser = m.contract("SampleEVMCallUser", [dataBridgeAddress, queryId, guardianAddress, governanceAddress]);

  return { sampleEVMCallUser };
});
