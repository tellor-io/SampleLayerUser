...
module.exports = buildModule("SamplePriceFeedUserModule", (m) => {
  ...
  const samplePriceFeedUser = m.contract("SamplePriceFeedUser", [dataBridgeAddress, queryId, guardianAddress]);

  return { samplePriceFeedUser };
});
