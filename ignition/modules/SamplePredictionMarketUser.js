...
module.exports = buildModule("SamplePredictionMarketUserModule", (m) => {
  ...
  const samplePredictionMarketUser = m.contract("SamplePredictionMarketUser", [dataBridgeAddress, queryId, guardianAddress]);

  return { samplePredictionMarketUser };
});
